...
export class LoginAdminComponent implements OnInit {
  ...
  constructor(private cookieService: CookieService, public router: Router, private readonly meta: MetaService) {
    ...
    this.meta.setTitle('MD Stock International - admin login');
      ...
      this.meta.setTag('og:title', 'MD Stock International - admin login');
      this.meta.setTag('twitter:title', 'MD Stock International - admin login');
